...
**실행 전 `references/flow.md`를 반드시 Read 한다 — 안 읽고 리뷰어 스폰 금지.** 전체 실행 절차·단계 역할표·공통 규약·가드레일이 거기 있고, 역할은 그 표에서 꺼내 쓴다(즉석 발명 금지).
...
## 자기개선 피드백
이 스킬을 쓰다 발견한 결함·개선점은 **그 자리서 고치지 말고** 작업 종료 후 이 폴더의 `feedback.md`에 한 줄 누적한다(반영은 관련 주제 재등장 시 사용자 승인 하에). 전체 규약 = `../_shared/self-improvement-feedback.md`.
