...
- **다음: Step6(격리 하네스 E2E — 데몬 단독 WS: auth/순서/truncated/reconnect resume/slow-consumer/데몬kill→PTY정리/breakaway). 별건: 타입 드리프트 게이트, Origin 실측, 프론트 DaemonClient(phase4), WMI 실 spawn 통합 실측(현재 #[ignore]).**
