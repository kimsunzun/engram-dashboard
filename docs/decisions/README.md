...
| [0136](0136-명령-인자의-모르는-칸-입구는-거절-배선은-관용.md) | 명령 인자의 모르는 칸 — 입구는 거절, 배선은 관용 | 확정 |
| [0137](0137-버전-불일치는-끊지-않고-알린다-능력-광고-시작-시-1회-고지.md) | 버전 불일치는 끊지 않고 알린다 — 능력 광고 + 시작 시 1회 고지 | 확정 |
