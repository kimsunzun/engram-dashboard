...
| [0128](0128-우편-채널-하드-단일화-capability로만-갈리고-물리-배선도-교육과-등호.md) | 우편 채널 하드 단일화 — capability로만 갈리고 물리 배선도 교육과 등호 | 확정 |
| [0129](0129-데몬-lib-3층-분리-네트워크-lib-에이전트-시스템-lib-얇은-조립-바이너리.md) | 데몬 lib 3층 분리 — 네트워크 lib · 에이전트 시스템 lib · 얇은 조립 바이너리 | 확정 |
