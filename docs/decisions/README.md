...
| [0094](0094-s17-에이전트-간-발신-권한-런타임-최소권한-pre-authorization-grant-seam.md) | S17 에이전트 간 발신 권한 — 런타임 최소권한 pre-authorization (grant seam) | 확정 |
| [0095](0095-봉투-포맷-스위칭-구조-기본-colon대체-xml-bracket-기각.md) | 봉투 포맷 스위칭 구조 — 기본 colon·대체 xml (bracket 기각) | 확정 |
