...
| [0064](0064-슬롯-컨텍스트-메뉴-단일-기여-api-공통-target별-콘텐츠-co-location-등록-일원화-command-단일소스.md) | 슬롯 컨텍스트 메뉴 = 단일 기여 API (공통 target=별 + 콘텐츠 co-location + 등록 일원화, command 단일소스) | 확정 |
