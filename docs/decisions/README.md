...
| [0107](0107-메일박스-용량순서-모델-v2-유계-2레인압력-회수in-flight-회계-c4-게이트-round-69.md) | 메일박스 용량·순서 모델 v2 — 유계 2레인·압력 회수·in-flight 회계 (C4 게이트 round 6~9) | 확정 |
| [0108](0108-request-계약-수명-기한-초과에도-미회신은-오픈-유지-cap-은퇴는-mark-and-sweep-d-게이트-round-27.md) | request 계약 수명 — 기한 초과에도 미회신은 오픈 유지 + cap 은퇴는 mark-and-sweep (D 게이트 round 2~7) | 확정 |
| [0109](0109-그룹-v1-관리-semantics듀얼-입구-계약-전원-수정암묵-생성-예약정규화-단일점-settings-파일-주입.md) | 그룹 v1 관리 semantics·듀얼 입구 계약 — 전원 수정·암묵 생성·@ 예약·정규화 단일점·--settings 파일 주입 | 확정 |
