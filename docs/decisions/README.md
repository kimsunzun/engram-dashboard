...
| [0141](0141-빈-슬롯-어포던스-중앙-아이콘-단독-슬롯-id-텍스트-제거-클릭-우클릭과-동일-메뉴.md) | 빈 슬롯 어포던스 = 중앙 + 아이콘 단독 (슬롯 id 텍스트 제거, 클릭 = 우클릭과 동일 메뉴) | 확정 (부분 폐기 by ADR-0143: 클릭 대상과 아이콘 상호작용성) |
| [0142](0142-우편-배달-병렬화-축과-같은-세션-배제-축.md) | 우편 배달 병렬화 축과 같은 세션 배제 축 | 확정 |
| [0143](0143-빈-슬롯-좌클릭-슬롯-전체-아이콘은-순수-그림.md) | 빈 슬롯 좌클릭 = 슬롯 전체 (아이콘은 순수 그림) | 확정 |
