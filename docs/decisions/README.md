...
| [0126](0126-mcp-실패-시-cli-우회-교육-폐지-입구는-스폰-시-capability로만-갈리고-런타임-폴백은-없다.md) | MCP 실패 시 CLI 우회 교육 폐지 — 입구는 스폰 시 capability로만 갈리고 런타임 폴백은 없다 | 확정 (부분 폐기 by ADR-0128: 결정 3 배선 존치 / ADR-0211: 프라이밍 B 의존 조항) |
