...
| [0134](0134-릴리스-데이터-폴더를-실행-폴더-하위-engram-data-로-단일-인스턴스-스코프를-데이터-폴더-기준으로.md) | 릴리스 데이터 폴더를 실행 폴더 하위 engram-data 로 + 단일 인스턴스 스코프를 데이터 폴더 기준으로 | 확정 (부분 폐기 by ADR-0135: 연결키 파일을 잠금 파일에 통합) |
