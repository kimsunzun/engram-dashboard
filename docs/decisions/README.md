...
| [0066](0066-슬롯-포커스배치-제어-표면-click-to-focus-focus-then-place-slot-geometry-노출-5-llm-제어.md) | 슬롯 포커스·배치 제어 표면 — click-to-focus + focus-then-place + slot geometry 노출 (§5 LLM 제어) | 확정 |
