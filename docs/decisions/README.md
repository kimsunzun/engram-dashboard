...
| [0160](0160-상태의-거처는-누가-보나와-언제까지-사나로-정한다.md) | 상태의 거처는 누가 보나와 언제까지 사나로 정한다 | 확정 |
| [0161](0161-에이전트-실패는-미리-감지하지-않고-실패한-자리에서-기록한다.md) | 에이전트 실패는 미리 감지하지 않고 실패한 자리에서 기록한다 | 확정 |
| [0162](0162-실패-표시는-트리에서-기호를-갈아끼우고-슬롯은-기존-종료-화면에-얹는다.md) | 실패 표시는 트리에서 기호를 갈아끼우고 슬롯은 기존 종료 화면에 얹는다 | 확정 |
