...
- 상태: 확정 (2026-06-21, dashboard10 세션 — 사용자 결정) · 부분 폐기 by ADR-0134 (단일 인스턴스 스코프와 릴리스 데이터 폴더 위치 대체)
- 관련: ADR-0020(프로토콜+transport seam — InProc carrier 제거)·ADR-0026(2프로세스 토폴로지 — daemon-only 로 좁힘)·ADR-0027(모드별 인스턴스/데이터 — **본 ADR이 폐기**, Supersedes ADR-0027)·ADR-0028(이벤트버스)·ADR-0013(tmux/Docker daemon-always 참조) · `docs/process/step-log.md` dashboard10 · Amended by ADR-0134 (단일 인스턴스 스코프와 릴리스 데이터 폴더 위치 대체)
