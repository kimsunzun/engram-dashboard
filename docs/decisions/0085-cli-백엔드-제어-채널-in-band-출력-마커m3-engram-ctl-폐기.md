...
- 관련: Supersedes ADR-0080(engram-ctl ingress 폐기) · CLAUDE.md §5(LLM-우선 제어)·아키텍처 「백엔드 확장」(capability matrix) · ADR-0002(capability = transport ⊕ backend)·ADR-0081(UI opaque-relay 존속)·ADR-0079(resume seed 경계)·ADR-0003(core 격리) · 결정 노트 `docs/process/S17-llm-control-surface/control-channel-deliberation-m3.md` · step-log S17
