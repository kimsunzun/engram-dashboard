...
- 상태: **제안(Proposed)** (2026-06-17, 방향만 고정 — 구현은 나중. 다음 세션들이 command를 이 형태로 쌓게 하기 위한 기록.) · 부분 폐기 by ADR-0134 (미해결 forks 3건 소진)
- 관련: CLAUDE.md §5(LLM-우선 제어, 모든 메뉴 프로그래밍 가능) · ADR-0011(agentClient 제어 표면) · ADR-0020(단일 dispatch) · ADR-0021(데몬 lifecycle command) · 백로그 "data-driven 우클릭 메뉴" · Amended by ADR-0134 (미해결 forks 3건 소진)
