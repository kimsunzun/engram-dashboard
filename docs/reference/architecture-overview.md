...
flowchart BT
  ...
  core["core [lib]<br/>에이전트 엔진(tauri import 0 · protocol 무의존 — wire 타입을 모른다<br/>seam: transport/backend/control)"]
