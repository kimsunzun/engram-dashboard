// ChatScrollArea 스모크 테스트(ADR-0053 seam). overlay/hover/0.5s-delay/auto-scroll 의 실제 거동은
...
describe('ChatScrollArea (ADR-0053 오버레이 스크롤바 seam)', () => {
  it('children 을 렌더한다', () => {
    render(
      <ChatScrollArea>
