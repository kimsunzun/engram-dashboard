// WS binary output frame 디코드 — 데몬 codec.rs `encode_terminal_frame`/`decode_frame` 의 역.
//
...
// 헤더 포맷은 tag 무관 동일 — payload 해석만 tag 로 갈린다.
 ...
 * payload 는 raw 로 넘긴다 — tag 별 해석(바이트 vs JSON)은 소비자 몫.
 */
