...
> "Codex MCP가 연결되지 않았습니다 — Codex blind 렌즈 없이 Claude 단독 리뷰만 가능합니다 (cross-family 교차검증 불성립). 계속 진행하시겠습니까, 아니면 Codex 연결 후 재실행하시겠습니까?"

사용자 확인 없이 **조용히 Claude로 대체하지 않는다** — 그렇게 하면 교차검증이 없었음에도 리뷰가 완료된 것처럼 보인다.
