 ...
 */
output_format: ClaudeOutputFormat, request_id: RequestId, } } | { "DeleteProfile": { profile_id: string, request_id: RequestId, } } | { "SpawnProfile": { profile_id: string, resume: boolean, request_id: RequestId, } } | { "SetProfileAutoRestore": { profile_id: string, auto_restore: boolean, request_id: RequestId, } } | { "GetSnapshot": { agent_id: string, request_id: RequestId, } } | { "ListPresets": { request_id: RequestId, } } | { "CreatePreset": { cwd: string, request_id: RequestId, } } | { "DeletePreset": { preset_id: string, request_id: RequestId, } };
