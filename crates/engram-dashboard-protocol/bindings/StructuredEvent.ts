...
import type { QueuedInputEvent } from "./QueuedInputEvent";
 ...
 */
id: string | null, turn_id: string | null, message_id: string | null, } | { "type": "Usage", input_tokens: number, output_tokens: number, turn_id: string | null, } | { "type": "MessageDone", turn_id: string | null, message_id: string | null, } | { "type": "TurnEnd", turn_id: string | null, outcome: TurnOutcome, } | { "type": "Error", message: string, } | { "type": "Structured", kind: string, json: string, } | { "type": "QueuedInput", op: QueuedInputEvent, };
